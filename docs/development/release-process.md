...
graph TD
    ...
    H[Git-cliff + cliff.toml<br/>Conventional Commits] --> I[CHANGELOG-OPENAPI.md<br/>Path: docs/**, openapi/**]
    H --> J[CHANGELOG-GEM.md<br/>Path: lib/**, test/**]
    H --> K[Release Notes<br/>docs/release-notes/v{version}.md]
    
    L[GitHub Actions<br/>release-tag.yml] --> M[Auto-generate all changelogs]
    L --> N[Deploy VitePress docs]
    L --> O[Publish gem with OIDC]
```
...
- ✅ Generate `CHANGELOG-OPENAPI.md` with git-cliff (docs/API changes)
- ✅ Generate `CHANGELOG-GEM.md` with git-cliff (Ruby gem changes)  
- ✅ Create release notes with git-cliff + installation guides
- ✅ Build VitePress documentation with `npm run docs:build`
...
5. Deploy VitePress documentation to GitHub Pages
6. Create a GitHub Release using the pre-generated git-cliff release notes
7. Build the gem
